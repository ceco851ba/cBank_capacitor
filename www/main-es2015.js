...
const routes = [
    ...
    {
        path: 'chart',
        loadChildren: () => Promise.all(/*! import() | pages-chart-chart-module */[__webpack_require__.e("default~pages-chart-chart-module~pages-statchart-statchart-module"), __webpack_require__.e("pages-chart-chart-module")]).then(__webpack_require__.bind(null, /*! ./pages/chart/chart.module */ "./src/app/pages/chart/chart.module.ts")).then(m => m.ChartPageModule)
    },
    {
        path: 'statchart',
        loadChildren: () => Promise.all(/*! import() | pages-statchart-statchart-module */[__webpack_require__.e("default~pages-chart-chart-module~pages-statchart-statchart-module"), __webpack_require__.e("pages-statchart-statchart-module")]).then(__webpack_require__.bind(null, /*! ./pages/statchart/statchart.module */ "./src/app/pages/statchart/statchart.module.ts")).then(m => m.StatchartPageModule)
    }
];
    ...
    GenerateProfile() {
        this.storage.get('user').then((val) => {
            if (val === null) {
                ...
                let usr = new _user__WEBPACK_IMPORTED_MODULE_10__["User"]();
                usr = JSON.parse(val);
                this.profile = usr;
                console.log(usr);
            }
    ...
    CreateTransactionList() {
        this.storage.get('transactions').then((val) => {
            if (val === null) {
                ...
                ), new _my_transaction__WEBPACK_IMPORTED_MODULE_11__["MyTransaction"]().generateTransaction(1, 1, 0, 'SK5217992356436464634643', 'SK521799134t4t2735342558', 'Lukoil Slovakia', 60, "Auto", "PHM", 1575547568031), new _my_transaction__WEBPACK_IMPORTED_MODULE_11__["MyTransaction"]().generateTransaction(2, 0, 1, 'SK4465436567568687878787', 'SK5217992356436464634643', 'xxx', 355, "ine", "zaloha", 1575677560031), new _my_transaction__WEBPACK_IMPORTED_MODULE_11__["MyTransaction"]().generateTransaction(3, 1, 0, 'SK5217992356436464634643', 'SK521799134t4t2735342558', 'Shell Slovakia', 58, "Auto", "PHM", 1575547568033), new _my_transaction__WEBPACK_IMPORTED_MODULE_11__["MyTransaction"]().generateTransaction(4, 1, 0, 'SK5217992356436464634643', 'SK4346657575454534634899', 'Alza', 100, "Obchod", "stotabletovtyzdenne", 1575547560031));
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_9__["Storage"]])
], AppModule);
...
/***/ "./src/app/my-transaction.ts":
/*!***********************************!*\
  !*** ./src/app/my-transaction.ts ***!
  \***********************************/
/*! exports provided: MyTransaction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyTransaction", function() { return MyTransaction; });
class MyTransaction {
    generateTransaction(transactionId, receiverId, senderId, senderIBAN, receiverIBAN, receiverName, amount, transactionCategory, message, transactionTimestamp) {
