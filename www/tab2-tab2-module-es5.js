...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(storage, navController) {
        var _this = this;
        ...
        this.storage.get('transactions').then(function (val) {
            ...
            _this.TransactionsList.forEach(function (transaction) {
                if (transaction.recieverId !== _this.profile.userId && transaction.senderId !== _this.profile.userId) {
                    _this.TransactionsList.splice(transaction.transactionId, 1);
                }
            });
        });
    }
    Tab2Page.prototype.returnToProfileButtonOnclick = function () {
        this.navController.navigateRoot("tabs/tab1");
    };
    Tab2Page.prototype.gotoChartButtonOnclick = function () {
        this.navController.navigateForward("statchart");
    };
    Tab2Page.prototype.gotoNewTransaction = function () {
    ...
    Tab2Page.prototype.refreshOnClick = function () {
        var _this = this;
        this.storage.get('user').then(function (val) {
            _this.profile = JSON.parse(val);
        });
    ...
    Tab2Page.prototype.transactionDetailClick = function (inTransaction) {
